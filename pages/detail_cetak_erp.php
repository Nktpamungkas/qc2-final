...
$Data .="DMD:".$_POST['nodemand']." /ERP:".$_POST['lot']."\n";	
//$Data .="ERP:".$_POST['nokk']."\n";
$Data .=$_POST['no_order']."\n";	
...
$Data .=$_POST['qty3']."x".$_POST['qty4']." ".$_POST['lebar']."x".$_POST['grms']."\n";
$Data .=$_POST['mc']." /".$_POST['suhu']." /".$_POST['speed']." /".$_POST['demanderp']."\n";
$Data .=$_POST['loterp']."\n";
...
unlink($file);
	...
	?>
<script> 
window.location.href='../InputDataERP-<?php echo $_POST['nodemand'];?>';
</script>    
