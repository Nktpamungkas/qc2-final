    ...
    <div class="box-body">
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <input name="nodemand" type="text" class="form-control" id="nodemand" onchange="window.location='InputDataDYEERP-'+this.value" value="<?php echo $_GET['nodemand']; ?>" placeholder="No Demand" required>
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input name="mc" type="text" class="form-control" id="mc" value="<?php echo $dtSch['no_mesin']; ?>" placeholder="Mesin">
          </div>
        </div>
        <div class="form-group">
          <label for="proses" class="col-sm-3 control-label">Proses</label>
          <div class="col-sm-6">
            <input name="proses" type="text" class="form-control" id="proses" value="<?php echo $dtSch['proses']; ?>" placeholder="Proses">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <input name="k_resep" type="text" class="form-control" id="k_resep" value="<?php echo $dtDyeing['k_resep']; ?>" placeholder="K.Resep" readonly>
          </div>
        </div>
        <div class="form-group">
