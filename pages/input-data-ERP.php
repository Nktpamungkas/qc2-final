	...
	<div class="box box-info">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<input name="nodemand" type="text" class="form-control" id="nodemand"
							onchange="window.location='InputDataERP-'+this.value"
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input name="lot" type="text" class="form-control" id="lot"
							value="<?php echo $dt_ITXVIEWKK['PRODUCTIONORDERCODE']; ?>" placeholder="Prod Order / Lot">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input name="demanderp" type="text" class="form-control" id="demanderp"
							value="<?= $dt_ITXVIEWKK['LOT']; ?>" placeholder="Lot Legacy">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="loterp" type="text" class="form-control" id="loterp"
							value="<?= $dt_stdcckwarna['STANDART_COCOK_WARNA']; ?>" placeholder="Previous Order">
					</div>
					<!--<div class="col-sm-2">
					<input name="demanderp" type="text" class="form-control" id="demanderp" 
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group date">
							<div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
							<input name="tgl_finishing" type="text" class="form-control pull-right" id="datepicker3"
								placeholder="00-00-0000" value="<?php echo $dtFin['tgl_o']; ?>" autocomplete="off" />
						</div>
					</div>
				</div>
				<div class="form-group">
		...
		<div class="box-footer">
			<?php if ($_GET['nodemand'] != "") { ?>
				<button type="submit" class="btn btn-danger pull-right" name="cetak" value="cetak"><i
