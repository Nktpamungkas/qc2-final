...
// $qryFin=mysqli_query($con,"SELECT *,DATE_FORMAT(tgl_proses_out,'%d-%m-%Y') as tgl_o FROM tbl_produksi WHERE nokk='$nodemand' ORDER BY id DESC LIMIT 1");
	  ...
	  <div class="col-md-6">
      	...
      	<div class="form-group">
				  ...
				  <input name="nodemand" type="text" class="form-control" id="nodemand" 
                     onchange="window.location='InputDataERP-'+this.value" value="<?php echo $_GET['nodemand'];?>" placeholder="No Demand" required  autocomplete="off">
		  </div>
		</div>
		<div class="form-group">
	  ...
	  <div class="col-md-6">
		...
		<div class="form-group">
			  ...
			  <div class="col-sm-2">
				...
				value="<?php if($cek>0){echo $rcek['rol'];}else{if($rowr['JML_ROLL'] != 0){echo $rowr['JML_ROLL'];}} ?>" placeholder="0.00" >
			  </div>
			  <div class="col-sm-3">
				<div class="input-group">  
				<input name="qty4" type="text" class="form-control" id="qty4" 
				value="<?php if($cek>0){echo $rcek['bruto'];}else{echo round($rowdb2['QTY_BAGI_KAIN'],2);} ?>" placeholder="0.00" style="text-align: right;" >
