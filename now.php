...
$sql_roll = db2_exec($conn1, "SELECT count(*) AS ROLL, 
                                        -- s2.PRODUCTIONORDERCODE,
                                        SUM(USERPRIMARYQUANTITY) AS QTY_BRUTO
                                        FROM STOCKTRANSACTION s2 
                                        WHERE s2.ITEMTYPECODE ='KGF'
                                        AND s2.PRODUCTIONORDERCODE = '$dt_ITXVIEWKK[PRODUCTIONORDERCODE]'
                                        AND PROJECTCODE = '$dt_ITXVIEWKK[PROJECTCODE]'
