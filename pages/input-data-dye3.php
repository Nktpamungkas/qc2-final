...
$qryDye=mysql_query("SELECT * FROM tbl_cocok_warna_dye WHERE nokk='$nokk' ORDER BY id DESC Limit 1");
$dtDye=mysql_fetch_array($qryDye);
$con2=mysql_connect("10.0.0.10","dit","4dm1n");
$db1=mysql_select_db("db_dying",$con2)or die("Gagal Koneksi ke Dyeing");
$qryDye1=mysql_query("SELECT * FROM tbl_hasilcelup WHERE nokk='$nokk' ORDER BY id DESC LIMIT 1");
$dtDyeing=mysql_fetch_array($qryDye1);
?>
<form class="form-horizontal" action="pages/cetak_label_new_dye.php" method="post" enctype="multipart/form-data" name="form1">
	  ...
	  <div class="col-md-6">
      	...
      	<div class="form-group">
				  ...
				  <input name="nokk" type="text" class="form-control" id="nokk" 
                     onchange="window.location='InputDataDYE3-'+this.value" value="<?php echo $_GET[nokk];?>" placeholder="No KK" required >
		  </div>
		</div>
		<div class="form-group">
	...
	<div class="form-group">
	  ...
	  <div class="col-md-6">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    value="<?php echo $dtDye[no_mesin]; ?>" placeholder="Mesin" >
                  </div>			  
                </div>
		  <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    value="<?php echo $dtDye[proses]; ?>" placeholder="Proses" >
                  </div>				   
          </div>		  
		  <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="input-group date">
            <div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
            <input name="tgl_celup" type="text" class="form-control pull-right" id="datepicker3" placeholder="00-00-0000" value="<?php echo $dtDye[tgl_celup]; ?>" />
          </div>
        </div>
