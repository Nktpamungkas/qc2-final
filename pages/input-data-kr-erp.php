...
<?php
	...
	// $sql = mysqli_query($con, "SELECT * FROM tbl_lap_inspeksi WHERE `nodemand` ='$nodemand' AND `dept`='QCF' ORDER BY id DESC LIMIT 1");
...
?>
<form class="form-horizontal" action="pages/detail_cetak_kr_erp.php" method="post" enctype="multipart/form-data" name="form1">
		...
		<div class="box-body">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input name="nodemand" type="text" class="form-control" id="nodemand" onchange="window.location='InputDataKRERP-'+this.value" value="<?php echo $_GET['nodemand']; ?>" placeholder="No Demand" required>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input name="lot" type="text" class="form-control" id="lot" value="<?php if ($cek > 0) {
																							...
																							}  ?>" placeholder="Prod Order / Lot">
					</div>
				</div>
				<div class="form-group">
					<label for="loterp" class="col-sm-3 control-label">Nokk /Lot Legacy</label>
					<div class="col-sm-3">
						<input name="loterp" type="text" class="form-control" id="loterp" value="" placeholder="No KK Legacy">
					</div>
					<div class="col-sm-2">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input name="speed" type="text" class="form-control" id="speed" value="<?php echo $dtFin['speed']; ?>" placeholder="0.00" style="text-align: right;">
							<span class="input-group-addon">speed</span>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<input name="suhu" type="text" class="form-control" id="suhu" value="<?php echo $dtFin['suhu']; ?>" placeholder="0.00" style="text-align: right;" required>
