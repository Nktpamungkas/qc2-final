...
$qryDye=mysqli_query($con,"SELECT * FROM tbl_cocok_warna_dye WHERE nokk='$nokk' ORDER BY id DESC Limit 1");
$dtDye=mysqli_fetch_array($qryDye);
$con2=mysqli_connect("10.0.0.10","dit","4dm1n");
$db1=mysqli_select_db($con2,"db_dying")or die("Gagal Koneksi ke Dyeing");
$qryDye1=mysqli_query($con2,"SELECT * FROM tbl_hasilcelup WHERE nokk='$nokk' ORDER BY id DESC LIMIT 1");
$dtDyeing=mysqli_fetch_array($qryDye1);
?>
<form class="form-horizontal" action="pages/detail_cetak_dye.php" method="post" enctype="multipart/form-data" name="form1">
	  ...
	  <div class="col-md-6">
      	...
      	<div class="form-group">
				  ...
				  <input name="nokk" type="text" class="form-control" id="nokk" 
                     onchange="window.location='InputDataDYE-'+this.value" value="<?php echo $_GET['nokk'];?>" placeholder="No KK" required >
		  </div>
		</div>
		<div class="form-group">
